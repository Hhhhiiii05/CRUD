...
<body>
  <div class="w-screen h-screen bg-purple-100 flex flex-col justify-center items-center shadow-lg">
    <div class="bg-zinc-100 w-3/4 h-auto rounded-lg p-5 md:w-1/2">
      <h1 class="text-4xl my-3.5 text-center font-semibold tracking-wides">Masuk</h1>
      <form class="flex flex-col my-4" action="" method="POST">
          ...
          <input class="mb-2 bg-[#9288F8] rounded-[8px] h-11 text-xl font-semibold tracking-wides text-[#322653] transition duration-400 ease-in-out hover:scale-105" type="submit" value="Login">
        </form>
        <p>Belum punya Akun? <a href="regis.php" class="text-[#9288F8] hover:underline ">Daftar disini</a></p>
    </div>
  </div>
</body>
</html>